...
--
-- Name: tb_ordem_item; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tb_ordem_item (
...
--
-- Name: tb_ordem_item tb_ordem_item_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_ordem_item
    ADD CONSTRAINT tb_ordem_item_pkey PRIMARY KEY (order_id, product_id);
...
--
-- Name: tb_ordem_item fk1d4tjugx5jjaa04ua3689270s; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_ordem_item
    ADD CONSTRAINT fk1d4tjugx5jjaa04ua3689270s FOREIGN KEY (product_id) REFERENCES public.tb_product(id);


--
-- Name: tb_ordem_item fk38fuyqhratbxp3sq3guwk5sww; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_ordem_item
    ADD CONSTRAINT fk38fuyqhratbxp3sq3guwk5sww FOREIGN KEY (order_id) REFERENCES public.tb_order(id);
