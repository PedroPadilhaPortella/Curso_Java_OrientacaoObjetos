...
import com.pedro.apirestmongo.resources.util.URL;
import com.pedro.apirestmongo.service.PostService;
...
public class PostResource
{
	...
	public ResponseEntity<List<Post>> fullSearch(
		...
		List<Post> posts = service.fullSeach(text, dateMin, dateMax);
		return ResponseEntity.ok().body(posts);
	}
}